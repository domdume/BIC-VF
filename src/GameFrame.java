...
public class GameFrame extends JFrame {
    public GameFrame() {
        ...
        this.setResizable(false); // The false argument does the window cannot be resized and will retain its
                                  // initial size
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // The application will close when the user closes the
                                                             // window
        this.setVisible(true);
        this.setLocationRelativeTo(null); // the true argument allows that the window appears in the center of the
                                          // user's screen
    }
}
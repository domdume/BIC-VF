...
public class IceCream2 extends Entity{
    /**
    ...
    }//para dos players aquí le ponen .VK_F
    ...
    private Direction getKeyXDirection(KeyEvent e) {
        return e.getKeyCode() == KeyEvent.VK_4 ? Direction.LEFT
                : e.getKeyCode() == KeyEvent.VK_6 ? Direction.RIGHT : Direction.NONE;
    }
    ...
    private Direction getKeyYDirection(KeyEvent e) {
        return e.getKeyCode() == KeyEvent.VK_5 ? Direction.DOWN
                : e.getKeyCode() == KeyEvent.VK_8 ? Direction.UP : Direction.NONE;
    }
